...
public class IntDriver extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setOutputKeyClass(NullWritable.class); //output key class for reduce function
        job.setOutputValueClass(LongWritable.class); //output value class for reduce function
        job.setMapOutputKeyClass(LongWritable.class); //output key class for map function
        job.setMapOutputValueClass(LongWritable.class); //output value class for map function
