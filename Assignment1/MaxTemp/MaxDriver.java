...
public class MaxDriver extends Configured implements Tool {
    ...
    private static final Logger THE_LOGGER = Logger.getLogger(MaxDriver.class);

    @Override
    public int run(String[] args) throws Exception {
        Job job = Job.getInstance();// creates new Hadoop job
        job.setJarByClass(MaxDriver.class);
        job.setJobName("MaxDriver"); //same as java class name 
        ...
        job.setMapperClass(MaxMapper.class);//sets the mapper
        job.setReducerClass(MaxReducer.class);//sets the reducer
    ...
    public static void main(String[] args) throws Exception {
        ...
        int returnStatus = ToolRunner.run(new MaxDriver(), args);
